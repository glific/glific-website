...
<div class="px-42 py-18 bg-theme-white-smoke">
		...
		?>
			...
			while ( have_posts() ) :
				...
				<a href="<?php echo get_field( 'link' ); ?>" class="text-decoration-none position-relative" target="_blank">					
					...
					<div class="description fz-18 text-theme-pewter"><?php echo get_field( 'description' ); ?> </div></div>
					</a>
					<svg class="position-absolute left-36 bottom-20"  width="18px" focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M9 5v2h6.59L4 18.59 5.41 20 17 8.41V15h2V5H9z" fill="#119656"></path></svg>					
				</div>	
				<?php
		endwhile;
			?>
