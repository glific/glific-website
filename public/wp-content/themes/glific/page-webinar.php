    ...
    <div class="webinar-container bg-theme-pewter">
        <div class="d-flex flex-column py-14 pb-18 py-md-14 pt-xl-20 pb-xl-18 w-328 w-xl-1092 w-md-641 mx-auto">
            ...
            <div class="video-container mt-6 mt-md-3 mt-xl-14 d-flex flex-column flex-md-row justify-content-between h-md-305 h-xl-486">
                <div class="selected-video-container w-328 w-xl-722 w-md-432 rounded-30">
                    <?php foreach ($webinar_container['video_container'] as $video) :
                        ...
                        <?php if (!empty($video_title) && !empty($video_duration)) : ?>
                            <div class="d-flex flex-row justify-content-between pt-md-4 align-items-center">
                                ...
                                <p class="font-heebo-regular fz-18 mb-0 selected-video-duration text-theme-nero"><?php echo $video_duration; ?> min</p>
                            </div>
                    <?php endif;
                        break;
                    endforeach; ?>
                    ...
                    <div class="scrollable-video-container d-flex flex-row flex-md-column h-md-264 w-full w-md-182 w-xl-315 h-xl-456 overflow-auto scrollbar-hidden
                        ...
                        <?php foreach ($webinar_container['video_container'] as $key => $video) :
                            ...
                            <div class="single-video-container w-124 d-flex flex-column mx-4 mx-md-0 w-xl-214 <?php echo empty($video_title) && empty($video_duration) ? 'mb-md-6 mb-xl-13' : ''  ?>" data-target="<?php echo $video_id; ?>">
                                <div class="w-124 w-xl-full h-82 h-xl-136 rounded-xl-30 rounded-15 c-pointer bg-size-contain align-items-center d-flex flex-column flex-md-row justify-content-center" 
                                ...
                                <?php if (!empty($video_title) && !empty($video_duration)) : ?>
                                    <div class="d-flex flex-column d-md-none">
                                        ...
                                        <p class="font-heebo-regular fz-12 leading-18 mb-0 mt-xl-7 text-left video-duration"><?php echo $video_duration; ?> min</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <?php if (!empty($video_title) && !empty($video_duration)) : ?>
