...
<div class="d-flex flex-column main-container bg-theme-white-smoke font-heebo-regular">
	...
	<?php endif; ?>
	<div class="subsection-container d-flex flex-column w-md-720 mx-auto ">
		<?php
		...
		if ( ! empty( $primary_section_data ) ) :
			foreach ( $primary_section_data as $key => $data ) :
				...
				?>
				<div class="flex-column flex-md-row d-flex justify-content-between mb-13.5 mb-xl-18 mb-md-20 ">
					<?php
					if ( $key % 2 === 1 ) :
						?>
