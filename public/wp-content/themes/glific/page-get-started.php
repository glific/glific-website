...
<div class="d-flex flex-column main-container bg-theme-white-smoke font-heebo-regular">
	<?php if ( ! empty( $main_heading ) ) : ?>
		<div class="justify-content-between w-320 w-md-310 mx-auto pt-18 pt-md-18 ">
			<h1 class="font-heebo-bold fz-28 leading-40 fz-md-36 text-theme-primary text-center"><?php echo $main_heading['title']; ?></h1>
		</div>
	...
	<?php endif; ?>
	<div class="subsection-container d-flex flex-column w-md-720 mx-auto mb-18">
		<?php
				...
				<div class="flex-column flex-md-row d-flex justify-content-between mb-13.5 mb-xl-18 mb-md-20 align-items-start">
					...
					if ( $key % 2 === 1 ) :
						...
						<div class="mr-md-17 w-300 mx-auto">
							...
							<div class="content fz-18 mb-6"><?php echo $data['content']; ?></div>
						...
						<div class="ml-md-17 w-300 mx-auto">
							<h2 class="font-weight-light text-theme-primary mb-8"><?php echo $data['title']; ?></h2>
							<div class="fz-18 content mb-6"><?php echo $data['content']; ?></div>
							<div class="fz-18 read-more text-theme-secondary font-weight-medium c-pointer"> Read more</div>
						</div>
						<?php
					endif;
	...
	<div class="subsection-container d-flex flex-column w-xl-856 w-md-720 w-320 mx-auto ">
	<h1 class="font-heebo-bold fz-24 leading-40 fz-md-24 text-theme-primary text-center mb-8">Latest case study</h1>
	<div>
<?php
	$posts = new WP_Query(
		array(
	...
	if ( $posts->have_posts() ) :
		?>
		<div class="d-flex flex-column-reverse flex-md-row  mx-auto  mx-md-6.5  rounded-top-30 rounded-bottom-left-30 box-shadow-light-10 p-7 mb-11 bg-white ">
			<?php
